...
import { ArrowRight, Camera, Video, Plane, Sparkles, Award, Heart, CheckCircle2 } from "lucide-react";
...
const services = [
  {
    ...
    description: "Immortalize your special day with our award-winning cinematic storytelling. We blend candid moments with breathtaking portraiture to craft timeless heirlooms.",
    icon: Heart,
    features: [
  ...
  },
  {
    ...
    description: "Elevate your brand identity with high-impact visual campaigns tailored for modern digital landscapes, fashion magazines, and global billboards.",
    icon: Camera,
    features: [
  ...
  },
  {
    ...
    description: "Capture grand perspectives with our FAA-certified drone pilots using state-of-the-art cinematic aerial cinematography platforms.",
    icon: Plane,
    features: [
  ...
  },
  {
    ...
    description: "Our in-house master retouchers meticulously enhance every pixel while preserving natural skin textures and authentic lighting.",
    icon: Sparkles,
    features: [
    ...
    <main className="min-h-screen bg-sand-bg text-sand-text pt-24 px-4 md:px-12 pb-24 font-sans selection:bg-yellow-500/30">
      ...
      <div className="max-w-7xl mx-auto mt-12">
              ...
              <div className="flex flex-col lg:flex-row justify-between gap-8 relative z-10">
                <div className="lg:max-w-2xl">
                  ...
                  <div className="space-y-3">
                    <h3 className="text-xs font-bold uppercase tracking-widest text-sand-muted mb-3">Key Highlights</h3>
                ...
                <div className="flex flex-col justify-between items-start lg:items-end border-t lg:border-t-0 lg:border-l border-sand-border pt-6 lg:pt-0 lg:pl-12 min-w-[280px]">
                  <div>
                    <span className="text-xs text-sand-muted uppercase tracking-wider block mb-1">Investment</span>
                    <span className="text-2xl font-serif font-bold text-sand-text">{service.price}</span>
                  </div>
                  <Link
                    href="/book"
        ...
        <div className="mt-24 text-center bg-sand-surface border border-sand-border rounded-3xl p-12 md:p-16 relative overflow-hidden">
          <h2 className="text-4xl md:text-5xl font-serif mb-4 capitalize lowercase">Have a custom project in mind?</h2>
